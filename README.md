...
| Multi-Head Attention | Multi-head attention as a block decomposition of the learned linear maps, with an interactive 3D attention-tensor view. | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/marimo-team/gallery-examples/blob/main/notebooks/math/multihead_attention.py) |
